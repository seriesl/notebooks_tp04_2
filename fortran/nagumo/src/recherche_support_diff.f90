      subroutine recherche_support_diff(maille, s_st, f_support, nn)
      ...
      INTEGER :: ir, jr, kr
      INTEGER :: i, j, k, l, lm, m, n, ll, mm, nn !var separees
      ...
      DOUBLE PRECISION :: rho_ec, rho_wall, rhoE_wall

      DOUBLE PRECISION, DIMENSION(-s_st:s_st,-s_st:s_st,-s_st:s_st,nvar) :: &
                    f_support
...
!.......... Si la cellule est interne (pas feuille) on met a jour sa valeur
!...........a partir de ses fils (feuilles reelles)
...
!          elseif( caltype_fin(3) == 0 ) then
      ...
      end subroutine recherche_support_diff
